...
export const productos: Product[] = [
  ...
  {
    id: 6,
    nombre: "Tinta Epson 664 Amarillo",
    categoria: "Consumibles",
    precio: 190,
    descripcion:
      "Botella de tinta original Epson T664120 color amarillo. Ideal para impresiones de alto rendimiento y calidad superior. Diseñada para proteger tu impresora y garantizar documentos nítidos.",
